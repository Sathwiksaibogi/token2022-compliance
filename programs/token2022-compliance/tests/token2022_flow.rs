...
fn token2022_compliance_flow() {
    ...
    println!(
        ...
        "Transfer-Hook token account size: {token_account_size} bytes"
    ...
    let token_account_rent =
        ...
        svm.minimum_balance_for_rent_exemption(token_account_size);
    ...
    let parsed_alice =
        ...
        StateWithExtensions::<Token2022Account>::unpack(

            &alice_token_account.data,
    ...
    let mint_after_minting =
        ...
        StateWithExtensions::<Token2022Mint>::unpack(

            &mint_after_minting_account.data,
    ...
    let (global_policy_pda, global_policy_bump) =
    ...
    let policy =
        ...
        token2022_compliance::state::GlobalPolicy::try_deserialize(
...
let (alice_authorization_pda, alice_authorization_bump) =
...
let (bob_authorization_pda, bob_authorization_bump) =
...
let initialize_authorizations_tx =
...
assert_eq!(
    ...
    alice_authorization_account.owner,
...
let mut alice_auth_data =

    alice_authorization_account.data.as_slice();



let alice_authorization =

    token2022_compliance::state::Authorization::try_deserialize(
...
assert_eq!(
    ...
    alice_authorization.bump,

    alice_authorization_bump
...
let mut bob_auth_data =

    bob_authorization_account.data.as_slice();
...
assert_eq!(
    ...
    bob_authorization.bump,

    bob_authorization_bump
...
let (alice_stats_pda, alice_stats_bump) =
...
let alice_stats =
    ...
    token2022_compliance::state::TransferStats::try_deserialize(

        &mut alice_stats_data,
...
let (extra_account_meta_list_pda, extra_account_meta_list_bump) =
...
let initialize_extra_account_meta_list_tx =
...
let expected_extra_account_meta_list_size =
    ...
    ExtraAccountMetaList::size_of(4)

        .expect("failed to calculate ExtraAccountMetaList size");
...
let alice_after_transfer =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &alice_after_transfer_account.data,
...
let bob_after_transfer =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &bob_after_transfer_account.data,
...
let mut alice_stats_after_data =

    alice_stats_after_account.data.as_slice();
...
let rejected_result =
    ...
    svm.send_transaction(rejected_transfer_tx);
...
let alice_after_rejection =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &alice_after_rejection_account.data,
...
let bob_after_rejection =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &bob_after_rejection_account.data,
...
assert_eq!(
    ...
    bob_after_rejection.base.amount,
...
let mut stats_after_rejection_data =

    stats_after_rejection_account.data.as_slice();



let stats_after_rejection =
...
assert_eq!(
    ...
    stats_after_rejection.total_transferred,
...
assert!(
    ...
    !bool::from(alice_hook_after_rejection.transferring)
...
assert!(
    ...
    !bool::from(bob_hook_after_rejection.transferring)
...
let transfer_90_ix =
    ...
    build_hooked_transfer(90 * 1_000_000);
...
let transfer_100_ix =
    ...
    build_hooked_transfer(100 * 1_000_000);
...
let stats_before_daily_rejection =
...
assert_eq!(
    ...
    stats_before_daily_rejection.total_transferred,
...
assert_eq!(
    ...
    stats_before_daily_rejection.transfer_count,
...
let daily_limit_rejection_ix =

    build_hooked_transfer(30 * 1_000_000);
...
let daily_limit_result =

    svm.send_transaction(daily_limit_rejection_tx);
...
let alice_after_daily_rejection =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &alice_after_daily_rejection_account.data,
...
let bob_after_daily_rejection =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &bob_after_daily_rejection_account.data,
...
assert_eq!(
    ...
    alice_after_daily_rejection.base.amount,
...
assert_eq!(
    ...
    bob_after_daily_rejection.base.amount,
...
let mut stats_after_daily_rejection_data =

    stats_after_daily_rejection_account.data.as_slice();



let stats_after_daily_rejection =
...
assert_eq!(
    ...
    stats_after_daily_rejection.amount_today,
...
assert_eq!(
    ...
    stats_after_daily_rejection.total_transferred,
...
let blocked_receiver_ix =

    build_hooked_transfer(1 * 1_000_000);
...
let blocked_receiver_result =

    svm.send_transaction(blocked_receiver_tx);
...
let alice_after_blocked_attempt =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &alice_after_blocked_attempt_account.data,
...
let bob_after_blocked_attempt =
    ...
    StateWithExtensions::<Token2022Account>::unpack(
        ...
        &bob_after_blocked_attempt_account.data,
...
let mut stats_after_blocked_attempt_data =

    stats_after_blocked_attempt_account.data.as_slice();



let stats_after_blocked_attempt =
...
assert_eq!(
    ...
    stats_after_blocked_attempt.total_transferred,
...
assert!(
    ...
    !bool::from(alice_hook_after_blocked.transferring)
...
assert!(
    ...
    !bool::from(bob_hook_after_blocked.transferring)
...
let direct_execute_ix = Instruction {
    ...
    data: token2022_compliance::instruction::Execute {
...
assert!(
    ...
    format!("{err:?}").contains("DailyLimitExceeded")
...
let tx = Transaction::new_signed_with_payer(
    ...
    &[
        ...
        create_alice_token_2_ix,

        initialize_alice_token_2_ix,
